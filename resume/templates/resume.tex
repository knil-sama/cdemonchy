...
\subsection{{%{ experience.role }% \hspace*{\fill} %{ experience.start_date }% --- %{ experience.end_date}%}}
\smallskip
\subtext{\href{%{ experience.company.url }%}{%{ experience.company.name }%} \hspace*{\fill} %{ experience.location }%}
\medskip
