...
<img alt="Previous solution" src={useBaseUrl('/img/EUOCRxTBTc3Z4Hb0AAPfPQ.webp')} />
...
<img alt="How we could have implemented S3pypi" src={useBaseUrl('/img/ke3DDc9Woaj2JZx5W-kuAw.webp')} />
...
<img alt="How we could have implemented Pypicloud" src={useBaseUrl('/img/v-jH4fEw3xsvTXZZ4cGOfg.webp')} />
...
<img alt="Pypicloud package pipeline" src={useBaseUrl('/img/lyn1pAHSw7PYMObHaaCOEg.webp')} />
...
<img alt="Pypicloud projects pipeline" src={useBaseUrl('/img/hR2hj50QfT6VcrxmQRBQTQ.webp')} />
